export default class VideoProcessor {
  ...
  encode144p(encoderConfig) {
    ...
    const readable = new ReadableStream({
      start: async(controller) => {
        ...
        if(!supported){
          const message = 'encode144p VideoEncoder is not supported'
  ...
  renderDecoderFramesAndGetEncodedChunks(renderFrame) {
    let _decoder
  ...
  async start({ file, encoderConfig, renderFrame, sendMessage }) {
    ...
    .pipeThrough(this.renderDecoderFramesAndGetEncodedChunks(renderFrame))
